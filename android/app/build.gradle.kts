...
android {
    ...
    buildTypes {
        release {
            // Falls back to the debug keystore only if key.properties is missing
            // (e.g. a fresh checkout before the release keystore is configured
            // locally) so `flutter run --release` keeps working out of the box.
